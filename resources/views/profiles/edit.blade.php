...
@section('content')
    <div class="bg-white dark:bg-gray-800 rounded-md shadow overflow-hidden">
        <!-- Encabezado de la sección de edición del perfil -->
        ...
        <div class="p-4">
            <form action="{{ route('profiles.update', $profile) }}" method="POST" enctype="multipart/form-data" class="space-y-4">
                ...
                <!-- Campo para la descripción del perfil -->
                <div>
                ...
                <!-- Campo para el tipo de ciclista -->
                <div>
                ...
                <!-- Campo para las rutas concurridas -->
                <div>
                ...
                <!-- Selector de lugar de interés principal -->
                <div>
                ...
                <!-- Selector de lugares de interés adicionales -->
                <div>
                ...
                <div class="flex items-center justify-end">
                    <a href="{{ route('profiles.index') }}" class="bg-gray-300 dark:bg-gray-600 hover:bg-gray-400 dark:hover:bg-gray-500 text-gray-800 dark:text-gray-200 font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline">
                        Cancelar
                    </a>
